...
function AboutContainer() {
  ...
  <div class="flex flex-col w-full mb-12 px-28">

  <div class="lg:flex-grow justify-around  lg:pr-24 md:pr-16 flex flex-row md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
  <div class="lg:max-w-lg lg:w-3/4 md:w-1/2 w-4/6 pr-12">
    ...
    <div class="flex flex-wrap -m-2 px-28">
      <div class="p-2 lg:w-1/4 md:w-1/2 w-full me-4">
      ...
      <div class="p-2 lg:w-1/4 md:w-1/2 w-full mx-4">
        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
